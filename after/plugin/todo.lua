...
local keywords =
	{ "FIX", "BUG", "ISSUE", "TODO", "HACK", "WARN", "PERF", "PERFORMANCE", "OPTIMIZE", "TEST", "TESTING", "FAILED" }
...
vim.api.nvim_set_keymap(
	"n",
	"<leader>t",
	":TodoTelescope keywords=FIX,BUG,ISSUE,TODO,HACK,WARN,PERF,PERFORMANCE,OPTIMIZE,TEST,TESTING,FAILED<CR>",
